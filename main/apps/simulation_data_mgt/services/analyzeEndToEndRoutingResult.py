# -*- coding: utf-8 -*-
"""
分析 EndToEndRouting（端到端路由）模組的模擬結果，提供統計、視覺化等功能。
"""
...
@log_trigger('INFO')
def analyzeEndToEndRoutingResult(simulation_result_dir):
    """
    讀取 end-to-end routing 模式產生的 output_build.csv，並將其轉為 JSON 後回傳。
